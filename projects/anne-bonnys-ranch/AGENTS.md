# Projektanweisungen: Anne Bonny's Ranch

## Einordnung

- **Arbeitsmodus:** `project-development`
...
Eigenständiges Coding- oder Lab-Projekt. Nicht automatisch als Bestandteil der OpenClaw-Kernarchitektur behandeln.
