...
### 2026-06-05 - Core-Agent-Dateien in rook-agent gemerged
- **Problem:** Core-Agent-Dateien (AGENTS.md, IDENTITY.md, SOUL.md, etc.) waren in beiden Repos (rook-workspace und rook-agent)
- **Lösung:** Identische Dateien aus rook-workspace entfernt, MEMORY.md gemerged (workspace → agent)
- **Skills:** 10 Skills aus workspace in rook-agent gemerged (bibigpt, blogwatcher, dispatch_canonical_task, gog, multi-search-engine, ontology, openclaw-update, proactive-agent-lite, rook-custom, xiucheng-self-improving-agent)
- **Ergebnis:** Saubere Trennung — rook-agent = Core System, rook-workspace = Arbeitsumgebung
- **Historie:** rook-agent hatte früher Workspace-Elemente (workspace-coach, workspace-engineer, sync-from-workspace.sh), die später in rook-workspace ausgelagert wurden
...
| 2026-06-05 | KI-Chronologie in digital-capitalism-research verschoben | Thematisch besser passend |
| 2026-06-05 | Core-Agent-Dateien in rook-agent gemerged | Saubere Trennung, keine Duplikate |
